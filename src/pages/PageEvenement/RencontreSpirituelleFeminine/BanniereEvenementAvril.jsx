...
function BanniereEvenementAvril()  {
  ...
  Rencontre spirituelle féminine
  </h1>
  <div className="mt-10 space-y-4 flex flex-col items-center">
    ...
    <div className="flex items-center space-x-4">
      ...
      <p className="text-base leading-7">41 Bd de Thibaud, 31100 Toulouse</p>
    </div>
    {/* Deuxième élément horizontal */}
    <div className="flex items-center space-x-4">
      <i className="fa-solid fa-location-dot text-2xl"></i> 
      <p className="text-base leading-7"> 14 Avril 2025 à partir de 13h30 </p>
    </div>
  </div>
  {/* Bouton 
  <div className="mt-10">
...
export default BanniereEvenementAvril;
