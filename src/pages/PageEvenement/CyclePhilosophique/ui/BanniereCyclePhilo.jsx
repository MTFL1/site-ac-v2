...
function BanniereEvenement2()  {
  ...
  <div className="mt-10 space-y-4 flex flex-col items-center">
    ...
    <div className="flex items-center space-x-4">
      ...
      <p className="text-base leading-7">14 rue Saint Bertrand, 31500 Toulouse </p>
    </div>
    {/* Deuxième élément horizontal */}
    <div className="flex items-center space-x-4">
      <i className="fa-solid fa-calendar text-2xl"></i> 
      <p className="text-base leading-7"> 1 Février 2026 à 19h00 </p>
    </div>
    {/* Deuxième élément horizontal */}
    <div className="flex items-center space-x-4">
      <i className="fa-solid fa-calendar text-2xl"></i> 
      <p className="text-base leading-7"> 22 Mars 2026 à 19h00 </p>
    </div>
    {/* Deuxième élément horizontal */}
    <div className="flex items-center space-x-4">
      <i className="fa-solid fa-calendar text-2xl"></i> 
      <p className="text-base leading-7"> 31 Mai 2026 à 19h00 </p>
    </div>
  </div>
  {/* Bouton 
  <div className="mt-10">
