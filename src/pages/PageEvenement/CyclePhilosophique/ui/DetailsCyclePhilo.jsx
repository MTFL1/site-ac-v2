  ...
  return (
    <section className="relative">
      ...
      <div className="relative flex flex-col w-full mx-auto text-gray-900 py-10 px-5 md:w-[60%]">
        {/* Titre */}
        <h1 className="text-4xl font-bold mb-6">Solenne Marchand</h1>
...
<br/>👉 de quoi notre âme a-t-elle réellement besoin pour ne pas s’assécher ?

        </p>
        
        {/* Image */}
        <img loading="lazy" src={Flyer15} alt="Flyer" className="object-contain rounded mb-6 w-full " />
