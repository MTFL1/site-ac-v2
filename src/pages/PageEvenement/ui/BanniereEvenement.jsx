...
function BanniereEvenement()  {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center text-white mx-auto max-md:mt-10 max-md:max-w-full">
      ...
      Art & spiritualité :  Poésie et nécessité intérieure
      </h1>
      <div className="mt-10 space-y-4 flex flex-col items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <p className="text-base leading-7">Club Alpin français, Toulouse </p>
        </div>
        {/* Deuxième élément horizontal */}
        <div className="flex items-center space-x-4">
          <i className="fa-solid fa-location-dot text-2xl"></i> 
          <p className="text-base leading-7"> 14 Décembre 2024 à 17h30 </p>
        </div>
      </div>
      {/* Bouton 
      <div className="mt-10">
