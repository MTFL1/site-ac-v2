...
function ProchainEvent() {
    ...
    const EventCard = ({ day, month, title, isLarge }) => (
        ...
        return(
          ...
          <section className="relative section-events flex flex-col justify-center items-center px-4 md:px-8 mt-12 w-full md:px-2 md:mt-10 md:max-w-full border">
  ...
  <div className="relative z-10 flex items-center w-full space-x-3 border max-w-screen-xl mx-auto">
    <span className="block w-10 h-1 bg-cyan-600"></span>
    <h3 className="text-gray-900 font-bold">NOS PROCHAINS ÉVÈNEMENTS</h3>
  </div>
  
  <div className="relative z-10 mt-6 w-full max-w-screen-xl mx-auto border">
