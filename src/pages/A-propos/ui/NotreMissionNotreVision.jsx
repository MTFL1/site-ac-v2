...
function NotreMissionNotreVision() {
  return (
    <section className="flex justify-center items-center relative self-stretch div-amber px-16 py-20 mt-0 w-full bg-amber-100 max-md:px-5 max-md:mt-0 max-md:max-w-full relative z-0">
      ...
      {/* Ajustement du z-index pour la div-amber */}
      <div className="flex gap-5 mt-[100px] max-md:flex-col max-md:gap-0">
        <div className="items-center gap-x-12 sm:px-4 md:px-10 md:py-10 lg:flex">
                <div className="max-w-xl px-4 space-y-3 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl">
                    ...
                    sociologie, histoire des idées, religion comparée, spiritualité,
                    science dures, art…
                    </p>
                </div>
            <div className="max-w-xl px-4 space-y-3 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl">
                ...
                <p className="mt-3 text-gray-900 text-xl text-justify first-letter:text-7xl first-letter:mr-3 first-letter:float-left">
                    ...
                    que c'est par l'expérience de l'autre qu'on se construit soi-même.
                </p>
            </div>
      </div>
      </div>
...
export default NotreMissionNotreVision;


<div className="flex flex-col mt-72 mb-4 w-full max-w-[1086px] max-md:mt-10 max-md:max-w-full"></div>